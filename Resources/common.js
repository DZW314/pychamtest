...
var SinMH = function ($) {
    ...
    function getChapterImage(page) {
        ...
        if (filename.match(/^https?:\/\/(images.dmzj.com|imgsmall.dmzj.com)/i)) return 'https://res02.333dm.com/showImage.php?url='+encodeURI(filename);
		if (filename.match(/^[a-z]\//i)) return 'https://res02.333dm.com/showImage.php?url='+encodeURI("https://images.dmzj.com/"+filename);
    ...
    function comicDiscussOpinion(param,fn) {
        var key = 'comic-discuss-opinion-' + param.discuss_id;
